...
- (NSArray *)additionCellItems{
    ...
    self.additionCellItem.title = CTFBLocalizedString(@"Additional detail");
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    switch (section) {
        ...
        case CTFeedbackSectionDeviceInfo:
            return self.hidesDeviceInfoCell ? nil : CTFBLocalizedString(@"Device Info");
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    switch (section) {
        ...
        case CTFeedbackSectionScreenshot:
            ...
            break;
        case CTFeedbackSectionDeviceInfo:
            if (self.hidesDeviceInfoCell) return CGFLOAT_MIN;
    }
    return 34;
}
